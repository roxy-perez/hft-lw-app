        ...
        <div class="grid grid-cols-1 gap-4 mt-4 lg:grid-cols-1 lg:gap-6">
            @foreach($accounts as $account)
                <x-card wire:key="{{ $account->id }}"
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="px-3 font-mono text-md">
                            <p class="text-primary-600 dark:text-primary-400">
                                ...
                                @endif
                                <x-heroicons::outline.currency-euro class="inline-flex text-gray-600 dark:text-primary-200"/>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end text-xs">
                        <div class="px-3 py-2">
                            <x-button label="Ver más" right-icon="eye" interaction="secondary" class="hidden md:inline-flex items-center"/>
                            <x-mini-button class="md:hidden" rounded primary icon="eye"/>
                            <x-button label="Borrar" right-icon="trash" interaction="secondary" class="hidden md:inline-flex" red/>
